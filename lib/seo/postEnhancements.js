...
const POST_ENHANCEMENTS = {
  ...
  'en-us/article/agent': {
    seoTitle:
      'OpenClaw AI Agent Framework Guide: Docs, Features, Use Cases, and Setup',
    seoDescription:
      'A practical OpenClaw AI agent framework guide covering docs intent, core features, setup flow, architecture, and real use cases for builders evaluating personal AI assistant stacks.',
    heroSummary:
      'A practical OpenClaw AI agent framework guide focused on docs intent, setup flow, architecture, and real builder use cases.',
    intentTitle: 'What this OpenClaw guide covers',
    intentText:
      'This article is for builders searching for OpenClaw documentation, OpenClaw framework setup, or real OpenClaw use cases. It focuses on what the framework does, how it fits personal AI assistant workflows, and what to evaluate before adopting it.',
    relatedLinks: [
      {
        title: 'Zotero arXiv Daily Workflow',
        href: '/article/zotero-arxiv-daily',
  ...
  'article/openclaw-popular-use-cases-2026': {
    seoTitle:
      'OpenClaw Use Cases 2026: Real Workflows, Setup Ideas, and Personal AI Assistant Examples',
    seoDescription:
      'Explore real OpenClaw use cases in 2026, including personal AI assistant workflows, automation ideas, setup patterns, and practical examples beyond simple demos.',
    heroSummary:
      'A practical guide to OpenClaw use cases, real workflow examples, and setup ideas for personal AI assistant projects in 2026.',
