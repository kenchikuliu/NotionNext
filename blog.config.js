...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是AI博士Charly，一名程序员，也是一个勤劳的打工人，当然还是个热爱美食的干饭人🍜！欢迎来到我的博客🎉，一起探索AI与科技的世界！',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AI博士Charly', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI博士Charly | 探索AI与自动化的未来', // 作者简介
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'hhczzz6688', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
