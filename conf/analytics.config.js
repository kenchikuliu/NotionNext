...
module.exports = {
  ...
  SEO_BING_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BING_SITE_VERIFICATION || '', // Bing Webmaster Tools verification code, emitted as msvalidate.01

  SEO_YANDEX_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_YANDEX_SITE_VERIFICATION || '', // Yandex Webmaster verification code

  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || '', // Remove the value or replace it with your own google site verification code

  // 微软 Clarity 站点分析
  CLARITY_ID: 'wju8qei921', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
