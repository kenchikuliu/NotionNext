const normalizeSlug = slug =>
  typeof slug === 'string' ? slug.replace(/^\/+|\/+$/g, '').toLowerCase() : ''
...
const AI_AGENT_COMPARISON_ENHANCEMENT = {
  seoTitle: 'Dify vs FastGPT vs Coze 2026: Best RAG Agent Tools',
  seoDescription:
    'Compare Dify vs FastGPT vs Coze for RAG knowledge-base agents, workflow automation, deployment fit, OpenClaw alternatives, and practical AI assistant projects.',
  heroSummary:
    'A practical Dify vs FastGPT vs Coze comparison for RAG knowledge-base assistants, workflow automation, and production AI agent projects in 2026.',
  intentTitle: 'What this Dify vs FastGPT comparison covers',
  intentText:
    'This article is for builders searching Dify vs FastGPT, FastGPT vs Dify, Coze, OpenClaw, and adjacent AI agent tools in 2026. It focuses on RAG capability, knowledge-base setup, workflow orchestration, deployment fit, and which platform is better for practical AI assistant projects.',
  relatedLinks: [
    {
    ...
    {
      title: 'FastGPT Deployment Guide',
      href: '/en-US/article/fastgpt-deployment-guide-ai-agent',
      description:
  ...
  faqItems: [
    ...
    {
      question: 'When is Coze a better fit than Dify or FastGPT?',
      answer:
...
const POST_ENHANCEMENTS = {
  'article/voice-input-ai-tools-2026': {
    ...
    faqItems: [
      {
        question:
          'What are users usually comparing when they search for AI voice input tools?',
        answer:
  ...
  'article/agent': AI_AGENT_COMPARISON_ENHANCEMENT,
  'article/aiagent': {
    seoTitle: 'AI Agent Tools 2026: RAG, Workflows, Frameworks Compared',
    seoDescription:
  ...
  'en-us/article/openclaw-ai-assistant-framework-2026': {
    seoTitle: 'OpenClaw GitHub and Official Docs: AI Assistant Framework',
    seoDescription:
  ...
  'article/openclaw-popular-use-cases-2026': {
    seoTitle: 'OpenClaw Use Cases 2026: Personal AI Assistant Workflows',
    seoDescription:
  ...
  'article/ai-agent-programming-2026': {
    seoTitle: 'AI Agent Programming 2026: Frameworks and Production Workflows',
    seoDescription:
  ...
  '干货分享/aixueshu': {
    seoTitle: '学术AI工具指南：AIxueshu 与常见学术 AI 工作流怎么用',
    seoDescription:
    ...
    relatedLinks: [
      {
        title: 'Zotero GPT Workflow',
        href: '/article/Zotero-GPT',
        description: '适合继续看如何把学术阅读、笔记和 AI 总结结合起来。'
      },
      {
        title: 'Zotero arXiv Daily Workflow',
        href: '/article/zotero-arxiv-daily',
        description: '适合做论文追踪与文献输入的前置工作流。'
      }
    ]
  },
  '干货分享/chatgptanki': {
    ...
    relatedLinks: [
      {
        ...
        href: '/article/indie-web-monthly-40k-usd-lessons',
        description: '适合继续看流量增长与收入模型如何连接到真实业务。'
      }
    ]
  },
  'article/comfyui': {
